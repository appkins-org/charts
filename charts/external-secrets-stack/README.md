...
![Version: 0.0.1](https://img.shields.io/badge/Version-0.0.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.14.0-snapshot.3](https://img.shields.io/badge/AppVersion-1.14.0--snapshot.3-informational?style=flat-square)

Helm chart for fully configuring a cilium cluster.
...
```shell
helm upgrade --install external-secrets-stack oci://ghcr.io/appkins/charts/external-secrets-stack --version 0.0.1
```
...
helm upgrade --install external-secrets-stack appkins/external-secrets-stack --version 0.0.1
```
...
| fluent-bit.config.outputs | string | `"[OUTPUT]\n  Name            prometheus_exporter\n  Match           node_metrics\n  Host            prometheus-prometheus.{{ include \"external-secrets-stack.domain\" .}}\n  port            9090\n  add_label       app fluent-bit\n\n[OUTPUT]\n  name                   loki\n  match                  *\n  Host                   loki.{{ include \"external-secrets-stack.domain\" .}}\n  labels                 job=fluentbit\n  auto_kubernetes_labels on\n\n[OUTPUT]\n  Name                 opentelemetry\n  Match                *\n  Host                 tempo.{{ include \"external-secrets-stack.domain\" .}}\n  Port                 3100\n  Metrics_uri          /api/v1/push\n  Logs_uri             /api/v1/push\n  Traces_uri           /api/v1/push\n  Log_response_payload True\n  Tls                  Off\n  Tls.verify           Off\n  # add user-defined labels\n  add_label            app fluent-bit\n  add_label            color blue\n"` |  |
...
| fullnameOverride | string | `"external-secrets-stack"` |  |
...
| loki.loki.schema_config.configs[0].object_store | string | `"{{ include \"external-secrets-stack.storage\" .}}"` |  |
...
| loki.loki.storage.s3.accessKeyId | string | `"{{ include \"external-secrets-stack.minio.user\" .}}"` |  |
| loki.loki.storage.s3.endpoint | string | `"{{ include \"minio.endpoint\" .}}"` |  |
| loki.loki.storage.s3.insecure | bool | `true` |  |
| loki.loki.storage.s3.secretAccessKey | string | `"{{ include \"external-secrets-stack.minio.password\" .}}"` |  |
| loki.loki.storage.type | string | `"{{ include \"external-secrets-stack.storage\" .}}"` |  |
...
| mimir.mimir.structuredConfig.blocks_storage.s3.access_key_id | string | `"{{ include \"external-secrets-stack.minio.user\" .}}"` |  |
...
| mimir.mimir.structuredConfig.blocks_storage.s3.secret_access_key | string | `"{{ include \"external-secrets-stack.minio.password\" .}}"` |  |
...
| nameOverride | string | `"external-secrets-stack"` |  |
...
| tempo.storage.trace.backend | string | `"{{ include \"external-secrets-stack.storage\" .}}"` |  |
| tempo.storage.trace.bucket | string | `"tempo"` |  |
| tempo.storage.trace.s3.access_key | string | `"{{ include \"external-secrets-stack.minio.user\" .}}"` |  |
...
| tempo.storage.trace.s3.secret_key | string | `"{{ include \"external-secrets-stack.minio.password\" .}}"` |  |
